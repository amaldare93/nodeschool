...
// call local module and pass params and callback function
lsfilter(dir, ext, function lsfilter_CB(err, list){
  // catch any error given by module function
  if (err)
    return console.error('ERROR: ', err);

  // print results
  list.forEach(function forEach_CB(file){
    console.log(file);
  });
